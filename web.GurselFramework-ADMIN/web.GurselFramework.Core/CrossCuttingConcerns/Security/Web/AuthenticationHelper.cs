...
namespace web.GurselFramework.Core.CrossCuttingConcerns.Security.Web
{
    ...
    {
        public static void CreateAuthCookie(Guid id, string userName, string email, DateTime expiration, string[] roles, bool rememberMe, string firstName, string lastName, bool isAdmin)
        {
            ...
            HttpContext.Current.Response.Cookies.Add(new HttpCookie("IsAdmin", isAdmin.ToString()));
        }
